...
: ${AMENT_CURRENT_PREFIX:="/all_sensors_launch/install/all_sensors_launch"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/all_sensors_launch/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/all_sensors_launch/environment/path.sh"
